...
We will be utilising the [server routes](https://nuxt.com/docs/guide/directory-structure/server) available within Nuxt, and to do so you'll need to create the `server/` directory within your website's root directly.
